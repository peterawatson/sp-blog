...
angular.module('spBlogger.posts.services',[]).factory('postService',function(){
	return {
		//posts: [{
			//id: 1,
			//title: 'Simple title1',
			//content: 'Sample content this is some sample content, this is some sample content, this is some sample content, this is some sample content, this is some sample content.',
